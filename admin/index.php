...
if ($op == 'delete') {
    $id = $_GET['id'];
    $sql1 = "select foto from cats where id = '$id'";
    $q1   = mysqli_query($koneksi, $sql1);
    $r1   = mysqli_fetch_array($q1);
    @unlink("../gambar/".$r1['foto']);

    $sql1 = "delete from cats where id = '$id'";
    $q1 = mysqli_query($koneksi, $sql1);
    if ($q1) {
...
?>
<h1>Halaman Admin Cats</h1>
<p>
    <a href="cats_input.php">
        <input type="button" class="btn btn-primary" value="Buat Cats Baru" />
    </a>
</p>
<?php
if ($sukses) {
...
<table class="table table-stripped">
    ...
    <tbody>
        ...
        $sql1  = "select * from cats $sqltambahan";
        ...
        while ($r1 = mysqli_fetch_array(result: $q1)) {
            ...
            <tr>
                ...
                <td><img src="../gambar/<?php echo cats_foto($r1['id'])?>" style="max-height:100px;max-width:100px"/></td>
                <td><?php echo $r1['nama'] ?></td>
                <td>
                    <a href="cats_input.php?id=<?php echo $r1['id']?>">
                        <span class="badge bg-warning text-dark">Edit</span>
                    </a>
                    
                    <a href="cats.php?op=delete&id=<?php echo $r1['id'] ?>"
